...
# Filename: ~/.scripts/colorscheme/colorscheme-selector.sh

# Path to the directory containing color scheme scripts
COLORSCHEME_DIR=~/.scripts/colorscheme/list

# Path to the colorscheme-set.sh script
COLORSCHEME_SET_SCRIPT=~/.scripts/colorscheme/colorscheme-set.sh
